              ...
              <tbody>
                {payments
                  .filter(payment => {
                    ...
                    return (
                      payment.cardHolderName?.toLowerCase().includes(q) ||
                      payment.cardNumber?.includes(q) ||
                      payment.whatsAppNumber?.includes(q) ||
